...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $schoolName = trim($_POST['school_name']); // اسم المدرسة
    ...
    $data = "اسم المدرسة: $schoolName | اسم الطالب: $studentName | رقم الهاتف: $phoneNumber | رقم بطاقة الكي كارد الخاصة به: $cardNumber | مبلغ القسط: $amount IQD | تحويل إلى: $receiverCard" . PHP_EOL;
