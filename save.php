...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $cardNumber = trim($_POST['card_number']); // رقم بطاقة الطالب الكي كارد
    ...
    $data = "اسم الطالب: $studentName | رقم الهاتف: $phoneNumber | رقم بطاقة الكي كارد الخاصة به: $cardNumber | مبلغ القسط: $amount IQD | تحويل إلى: $receiverCard" . PHP_EOL;
